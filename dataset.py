...
class coco_dataset(torch.utils.data.Dataset):
  ...
  def __getitem__(self, index):
    ...
    file_id = self.path + f'{self.mode}/images/coco_part' + f'{direc_id}/' + '0' * (6 - len(f'{image_id}')) + f'{image_id}.jpg'
    ...
    annotation = caption['annotation'][0].lower() # first caption in 5 captions
